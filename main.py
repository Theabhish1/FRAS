...
#Student BUTTONS
        ...
        b1_1=Button(bg_img,text="Face Detector",cursor="hand2",command=self.face_data,font=("times new roman",12,"bold"),bg="green",fg="white",activebackground="green",activeforeground="white")
        ...
        b1_1=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendance_data,font=("times new roman",12,"bold"),bg="green",fg="white",activebackground="green",activeforeground="white")
