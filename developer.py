...
class Developer:
    def __init__(self,root):
        ...
        dev2_Label = Label(main_frame, text="Course : B.Tech. (Final Year)", font=("times new roman", 10, "bold"), bg="white")
        dev2_Label.place(x=0,y=190)
         
          
        dev3_Label = Label(main_frame, text="Student of Neelkanth Insitite of Technology,Meerut", font=("times new roman", 8, "bold"), bg="white")
        dev3_Label.place(x=0,y=210)
        
        dev4_Label = Label(main_frame, text="For any issue contact us on:", font=("times new roman", 10, "bold"), bg="white")
        dev4_Label.place(x=0,y=240)
         
       # LinkedIn link
        linkedin_label = Label(main_frame, text="Linkedin- Abhishek", font=("times new roman", 12, "bold"), fg="white", cursor="hand2", bg="green")
        linkedin_label.place(x=0, y=260)
        linkedin_label.bind("<Button-1>", self.open_linkedin)

           
       # LinkedIn link
        linkedin_label_1= Label(main_frame, text="Linkedin- kushal", font=("times new roman", 12, "bold"), fg="white", cursor="hand2", bg="green")
