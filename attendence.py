...
class Attendence:
    def __init__(self,root):
        ...
        Left_frame.place(x=10,y=1,width=530,height=470)

        left_inside_frame=Frame(Left_frame,bd=2,relief=RIDGE,bg="white")#bd-border
        left_inside_frame.place(x=5,y=0,width=510,height=440)
        ...
        button_frame.place(x=0,y=410,width=507,height=30)
        ...
        Right_frame.place(x=550,y=1,width=690,height=470)

           #""""""""""""""""""""""""""""""""""""""""table_frame"""""""""""""""""""""""""
        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=6,y=1,width=670,height=430)

        #"""""""""""""""""""""""""""""""""""""""Scroll bar table"
        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.AttendanceReportTable=ttk.Treeview(table_frame,column=("id","name","roll","department","time","date","attendence"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.AttendanceReportTable.column("attendence",width=150)
